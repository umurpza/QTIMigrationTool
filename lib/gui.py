...
class MyFrame(wx.Frame):
    ...
    def __init__(self, parent, ID, title):
        ...
        wx.Frame.__init__(self, parent, ID, title,
                          ...
                          style=wx.DEFAULT_DIALOG_STYLE | wx.CAPTION | wx.SYSTEM_MENU)
        ...
        box1_title = wx.StaticBox(self, 107, "Convert...")
        self.grp1_ctrls = []
        radio1 = wx.RadioButton(self, 103, "", style=wx.RB_SINGLE)
        ffb1 = filebrowse.FileBrowseButton(self, 104, size=(450, -1),
        ...
        radio2 = wx.RadioButton(self, 105, "", style=wx.RB_SINGLE)
        dbb1 = filebrowse.DirBrowseButton(self, 106, size=(450, -1),
        ...
        # == Save files to...
        box2_title = wx.StaticBox(self, 109, "Save files to...")
        self.grp2_ctrls = []
        dbb2 = filebrowse.DirBrowseButton(self, 108, size=(475, -1),
        ...
        button1 = wx.Button(self, 1003, "Convert..")
        self.Bind(wx.EVT_BUTTON, self.ConvertMe, button1)
        button2 = wx.Button(self, 1004, "Close")
    ...
    def ReplaceMaxChoices(self, questionText):
        ...
        response_cases = re.findall(r'<(responseIf>.*?</responseIf|responseElseIf>.*?</responseElseIf)', questionText,
                                    re.DOTALL)
        amount_correct = 0
        for response_case in response_cases:
            if response_case.find('<variable identifier="MC"/>') != -1 and len(
                    re.findall(r'<baseValue baseType="(integer|float)">1</baseValue>', response_case)) > 0:
                amount_correct += 1
